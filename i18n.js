...
(function () {
  ...
  var T = {
    ...
    bg: {
      ...
      'banner.content': 'Пътна Помощ 24/7 &nbsp;|&nbsp; Бързо пристигане &nbsp;|&nbsp; Пътна Помощ София &nbsp;|&nbsp; Пътна Помощ Цени от 45€ &nbsp;|&nbsp; ЧМР застраховка 50 000€ &nbsp;|&nbsp;',

      /* Desktop Nav */
      'nav.home':      'Пътна Помощ',
      'nav.services':  'Услуги',
      'nav.sofia':     'Пътна Помощ София',
      ...
      /* Footer */
      'footer.desc':    'Лицензирана пътна помощ в София и страната. Надежден партньор за вашия автомобил, бус или камион.',
      'footer.h.contacts': 'КОНТАКТИ',
      'footer.location': 'София, България',
      'footer.h.services': 'УСЛУГИ',
      'footer.svc1':    'Пътна помощ София',
      'footer.svc2':    'Транспорт до 7 тона',
      'footer.svc3':    'Пътна помощ цени',
      ...
      'svc.h2':      'Пътна Помощ и Репатриране в София — Нашите Услуги',
      'svc.c1.h3':   'Пътна помощ със застраховка',
      ...
      'svc.c4.p':    'Покриваме София и цялата пътна мрежа на България. Фиксирани цени за дълги разстояния.',
      'svc.c4.link': 'Вижте цените &rarr;',
      'svc.para':    'Екипът на Арготранс – <a href="/putna-pomosht-sofia/" style="color:var(--yellow);">Пътна помощ София</a> предлага професионална и бърза помощ при аварии на пъта, както в рамките на София, така и в цялата страна и чужбина. Работим денонощно 24/7 и реагираме незабавно при всяка ситуация. Предлагаме репатриране на леки автомобили, джипове, бусове, мотори и специализирана техника до 7 тона. Вижте нашите <a href="/putna-pomosht-ceni/" style="color:var(--yellow);">пътна помощ цени</a> или се <a href="/kontakti/" style="color:var(--yellow);">свържете с нас</a>.',

      'gallery.label': 'НАШАТА РАБОТА',
      'gallery.h2':    'ГАЛЕРИЯ',

      'stats.eyebrow': 'ПОКРИТИЕ И НАДЕЖДНОСТ',
      'stats.h2':      'Пътна Помощ в София и Цяла България — Денонощно 24/7',
      'stats.p':       'Независимо дали сте закъсали на Околовръстното, в центъра на София или на магистрала Тракия, нашият екип пътува към вас.',
      'stats.l1':      'РАБОТНО ВРЕМЕ',
      'stats.l2':      'ПОКРИТИЕ СОФИЯ',
      'stats.l3':      'ЗАСТРАХОВКА',

      'why.eyebrow': 'ЗАЩО НАС?',
      'why.h2':      'Защо да изберете Арготранс за Пътна Помощ в София?',
      ...
      'faq.q2.h3':   'Колко струва пътна помощ в София?',
      'faq.q2.p':    'Цените започват от 45€ за лек автомобил в рамките на София. Джип — от 55€, бус — от 70€. За извънградски транспорт — 0.90€/км. Виж пълните <a href="/putna-pomosht-ceni/" style="color:#ffc800;">цени за пътна помощ</a>.',
      'faq.q3.h3':   'Работи ли Арготранс денонощно и в почивни дни?',
      'faq.q3.p':    'Да. Работим 24/7 — включително събота, неделя и официални празници. Пътната помощ не познава почивен ден.',
      ...
      'acc.t2':      'Репатриране и пътна помощ в цяла България',
      ...
      'ceni.faq.h2':       'Въпроси за Цените на Пътна Помощ',
      ...
      'lp.how.h2':      'Как работи Пътна Помощ?',
    ...
    en: {
      ...
      /* Urgency banner */
      'banner.content': 'Roadside Assistance 24/7 &nbsp;|&nbsp; Fast arrival &nbsp;|&nbsp; Roadside Assistance Sofia &nbsp;|&nbsp; Prices from &euro;45 &nbsp;|&nbsp; CMR insurance &euro;50,000 &nbsp;|&nbsp;',
